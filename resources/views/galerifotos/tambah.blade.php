            ...
            <div class="col-lg-20">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Tambah Data Galeri Foto</h5>
                        @if (count($errors) > 0)
                        ...
                        <form action="/postGalerifoto" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="foto" class="form-control" aria-describedby="passwordHelpBlock" placeholder="Masukan Foto">
