            ...
            <div class="col-lg-20">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Edit Data Halaman Statis {{ $statis['id'] }}</h5>
                        @if (count($errors) > 0)
                        ...
                        <form action="/updateStatis/{{ $statis['id'] }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                                <div class="col-sm-10">
                                    <input type="text" name="judul" class="form-control" aria-describedby="passwordHelpBlock" placeholder="Masukan Judul" value="{{ $statis['judul'] }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="tinymce-editor" name="isi" id="isi" style="height: 100px;" aria-describedby="passwordHelpBlock" placeholder="Masukan Isi"><?php echo $statis['isi'] ?></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="file" class="col-sm-2 col-form-label">File</label>
                                <div class="col-sm-10">
                                    <input type="file" name="file" class="form-control" aria-describedby="passwordHelpBlock" value="{{ $statis['file'] }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" name="tgl" class="form-control" aria-describedby="passwordHelpBlock" value="{{ $statis['tgl'] }}">
                                </div>
                            </div>
                            <div class="row mb-3">
