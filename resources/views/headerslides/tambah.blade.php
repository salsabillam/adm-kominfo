    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Header Slide</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-20">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Tambah Data Header Slide</h5>
                        @if (count($errors) > 0)
                        ...
                        <form action="/postHeaderslide" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
