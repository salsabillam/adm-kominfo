    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Dokumen</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-20">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/postDokumen" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="nama_doc" class="col-sm-2 col-form-label">Nama Dokumen</label>
                                <div class="col-sm-10">
                                    <input type="text" name="nama_doc" class="form-control" aria-describedby="passwordHelpBlock" placeholder="Masukan Nama Dokumen">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="keterangan" id="keterangan" style="height: 100px;" aria-describedby="passwordHelpBlock" placeholder="Masukan Keterangan"></textarea>
                                </div>
                            </div>
