    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Kategori Halaman Statis</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-20">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Tambah Data Kategori Halaman Statis</h5>
                        @if (count($errors) > 0)
                        ...
                        <form action="/postKathalstatis" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
